...
//       <div className="absolute z-30 top-[42px] sm:top-[200px] sm:left-[65px] justify-center items-center w-full px-10 sm:w-3/4 xl:-1/2 sm:px-0 sm:text-left">
//         <div className="container m-auto">
//           <div className="max-w-[650px] w-[100%] m-auto ">
//             <p className="opacity-3 sm:text-left text-center font-sans text-[#223740] mb-3">
//               Project Sample
//             </p>
//             <h1 className="opacity-3 text-[#224730] sm:text-left text-center w-full sm:w-3/4 font-recoletaBold text-4xl md:text-4xl lg:text-4xl xl:text-4xl">
//               {data.title}
//             </h1>
//           </div>
//         </div>
...
//           style={{ backgroundImage: `url(${DataArray[prev]?.images[0]})` }}
//         >
//           <a className="flex justify-center group:hover:bg[#223740] cursor-pointer transition-colors duration-500 bg-[#405866] bg-opacity-90 items-center w-full h-full"
//             //  onClick={()=> router.push(`/portfoliodetail/${prev}`)}
//           >
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
