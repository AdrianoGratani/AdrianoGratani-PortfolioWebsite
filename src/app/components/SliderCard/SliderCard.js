...
export default function SliderCard({ item, index }) {
  ...
  return (
    <React.Fragment>
      <div className="h-[280px] lg:h-[450px] md:-[400px] sm:-[200px] lg:w-[650px] md:w-[450px] sm:w-[300px] w-[300px] relative m-auto ">
        <div className="h-full w-full group cursor-all-scroll z-50 relative">
		  ...
		  className="absolute bottom-[270px] lg:bottom-44 md:bobttom-32 sm:bottom-[270px] left-6 rounded-lg transition duration-300 opacity-0 group-hover:opacity-100 bg-[#47626d] cursor-pointer flex items-center justify-center shadow-accent-color hover:shadow-xl hover:bg-[#47626d] w-10 h-10 md:w-12 md:h-12 lg:w-20 lg:h-20"
